# orbit Tracing with Langfuse

This cookbook provides comprehensive observability for orbit workflows using [Langfuse](https://langfuse.com/) as the tracing backend. With minimal code changes (just adding a decorator), you can automatically trace all node executions, inputs, outputs, and errors in your orbit workflows.
...
orbit_TRACING_DEBUG=true
orbit_TRACE_INPUTS=true
orbit_TRACE_OUTPUTS=true
orbit_TRACE_PREP=true
orbit_TRACE_EXEC=true
orbit_TRACE_POST=true
orbit_TRACE_ERRORS=true

# Optional session/user tracking
orbit_SESSION_ID=your-session-id
orbit_USER_ID=your-user-id
```
...
3. **"No traces appearing in dashboard"**
   - Ensure `orbit_TRACING_DEBUG=true` to see debug output
...
Decorator to add Langfuse tracing to orbit flows.
...
This cookbook is designed to be a starting point for orbit observability. Feel free to extend and customize it for your specific needs!

## 📄 License

This cookbook follows the same license as orbit.
