...
- Check out the [Substack Post Tutorial](https://orbit.substack.com/p/build-your-own-ai-code-generator) for more!
...
### Batch Processing
The **RunTests** node uses orbit's BatchNode to efficiently test the function against all test cases in parallel.
...
- **[Workflow](https://the-pocket.github.io/orbit/design_pattern/workflow.html)**: Sequential steps of test generation → coding → testing
- **[Agent](https://the-pocket.github.io/orbit/design_pattern/agent.html)**: Intelligent decision-making when tests fail
- **[Batch](https://the-pocket.github.io/orbit/core_abstraction/batch.html)**: Efficient parallel test execution
- **[Structured Output](https://the-pocket.github.io/orbit/design_pattern/structure.html)**: YAML validation for reliable LLM outputs 
