...
A minimal demo application showing how to use orbit to extract structured data from a resume using direct prompting and YAML formatting. Why YAML? Check out the [doc](https://the-pocket.github.io/orbit/design_pattern/structure.html).
