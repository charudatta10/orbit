# orbit Gradio HITL Example

A web-based application that demonstrates Human-in-the-Loop (HITL) workflow orchestration using orbit and Gradio. This example provides an interactive interface for users to engage with AI-powered tasks while maintaining human oversight and feedback.
...
This project is part of the orbit cookbook examples. It's assumed you have already cloned the [orbit repository](https://github.com/the-pocket/orbit) and are in the `cookbook/orbit-gradio-hitl` directory.
...
The system implements a orbit workflow with a web interface:
