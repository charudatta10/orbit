...
- Clean decision loop using orbit's action-based branching
...
```bash
python main.py --"What is the ReAct pattern and how does orbit support it?"
```
...
```
🤔 Question: How do nodes work in orbit?
...
🎯 Final Answer:
In orbit, nodes have three stages: prep (reads shared store),
