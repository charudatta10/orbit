...
This directory contains tools for visualizing orbit workflow graphs using interactive D3.js visualizations.

## Overview

The visualization tools allow you to:

1. View orbit nodes and flows as an interactive graph
...
To visualize a orbit graph, you can use the `visualize_flow` function in `visualize.py`:
...
cd cookbook/orbit-minimal-flow2flow
...
1. **Flow to JSON Conversion**: The `flow_to_json` function traverses the orbit graph and converts it to a structure with nodes, links, and group information.
