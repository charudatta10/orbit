# orbit Chat with Memory

A chat application with memory retrieval using orbit. This example maintains a sliding window of recent conversations while retrieving relevant past conversations based on context. 
