...
This project demonstrates using orbit's async and parallel features (`AsyncFlow`, `AsyncParallelBatchNode`) to translate a document into multiple languages concurrently.

- Check out the [Substack Post Tutorial](https://orbit.substack.com/p/parallel-llm-calls-from-scratch-tutorial) for more!
...
```
# --- Sequential Run Output (from orbit-batch) ---
