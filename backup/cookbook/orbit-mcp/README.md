...
This project shows how to build an agent that performs addition using orbit and Model Context Protocol (MCP). It presents a comparison between using MCP and basic function calling approaches.
...
The agent uses orbit to create a workflow where:
...
- [`main.py`](./main.py): Implementation of the addition agent using orbit
