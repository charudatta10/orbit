...
This project demonstrates a voice-based interactive chat application built with orbit. Users can speak their queries, and the system will respond with spoken answers from an LLM, maintaining conversation history.

- Check out the [Substack Post Tutorial](https://orbit.substack.com/p/build-your-own-voice-chatbot-from) for more!
...
2.  **Install dependencies**:
    ...
    ```
    This will install libraries such as `openai`, `orbit`, `sounddevice`, `numpy`, `scipy`, and `soundfile`.
...
The application uses a orbit workflow to manage the conversation steps:
