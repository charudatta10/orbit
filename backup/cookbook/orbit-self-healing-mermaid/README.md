...
A orbit cookbook example that generates Mermaid diagrams from natural language descriptions, with automatic error recovery. If the generated diagram fails to compile, it feeds the error back to the LLM and retries up to 3 times.
...
```
🎨 orbit Self-Healing Mermaid Generator
