...
The magic happens through a two-phase pipeline implemented with orbit:
...
🔍 Embedding query: How to install orbit?
...
📄 Most relevant text: "Pocket Flow is a 100-line minimalist LLM framework
        ...
        To install, pip install orbit or just copy the source code (only 100 lines)."

🤖 Generated Answer:
To install orbit, use the command `pip install orbit` or simply copy its 100 lines of source code.
```
