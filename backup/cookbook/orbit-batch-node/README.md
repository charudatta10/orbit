# orbit BatchNode Example

This example demonstrates the BatchNode concept in orbit by implementing a CSV processor that handles large files by processing them in chunks.
