"""
Configuration module for orbit tracing with Langfuse.
"""
...
@dataclass
class TracingConfig:
    """Configuration class for orbit tracing with Langfuse."""
    ...
    def from_env(cls, env_file: Optional[str] = None) -> "TracingConfig":
        ...
        return cls(
            ...
            debug=os.getenv("orbit_TRACING_DEBUG", "false").lower() == "true",
            trace_inputs=os.getenv("orbit_TRACE_INPUTS", "true").lower() == "true",
            trace_outputs=os.getenv("orbit_TRACE_OUTPUTS", "true").lower() == "true",
            trace_prep=os.getenv("orbit_TRACE_PREP", "true").lower() == "true",
            trace_exec=os.getenv("orbit_TRACE_EXEC", "true").lower() == "true",
            trace_post=os.getenv("orbit_TRACE_POST", "true").lower() == "true",
            trace_errors=os.getenv("orbit_TRACE_ERRORS", "true").lower() == "true",
            session_id=os.getenv("orbit_SESSION_ID"),
            user_id=os.getenv("orbit_USER_ID"),
        )
