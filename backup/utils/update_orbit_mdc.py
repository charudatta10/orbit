...
Usage:
    python update_orbit_mdc.py [--docs-dir PATH] [--rules-dir PATH]
"""
...
def get_mdc_description(md_file, frontmatter, heading):
    ...
    if section:
        return f"Guidelines for using orbit, {section}, {subsection}"
    else:
        return f"Guidelines for using orbit, {subsection}"
...
def create_combined_guide(docs_dir, rules_dir):
    ...
    description = "Guidelines for using orbit, Agentic Coding"
    ...
    output_path = rules_path / "guide_for_orbit.mdc"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate MDC files from orbit docs")
    
    # Get script directory
    script_dir = Path(__file__).parent.absolute()
    
    # Default to orbit/docs directory relative to script location
    ...
    parser.add_argument("--docs-dir", 
                        ...
                        help="Path to orbit docs directory")
