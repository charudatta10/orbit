"""
Setup and testing utilities for orbit tracing.
"""
...
def setup_tracing(env_file: Optional[str] = None) -> TracingConfig:
    ...
    """
    print("🔧 Setting up orbit tracing...")
    ...
    print("🎉 orbit tracing setup complete!")
    return config
...
def print_configuration_help():
    ...
    print("""
🔧 orbit Tracing Configuration Help

To use orbit tracing, you need to configure Langfuse credentials.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="orbit Tracing Setup")
