# orbit BatchFlow Example

This example demonstrates the BatchFlow concept in orbit by implementing an image processor that applies different filters to multiple images.
