...
@click.option(
    ...
    help="URL of the orbit A2A agent server.",
)
async def cli(agent_url: str):
    ...
    # Note: The orbit wrapper doesn't expose much via the AgentCard,
    ...
    while True:
        ...
        try:
            ...
            if response.error:
                ...
                # Extract answer from artifacts (as implemented in orbitTaskManager)
