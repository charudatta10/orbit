# OpenAI Embeddings with orbit

This example demonstrates how to properly integrate OpenAI's text embeddings API with orbit, focusing on:

1. Clean code organization with separation of concerns:
   - Tools layer for API interactions (`tools/embeddings.py`)
   - Node implementation for orbit integration (`nodes.py`)
...
2. Create a orbit node to handle embedding generation
