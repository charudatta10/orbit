# SQLite Database with orbit

This example demonstrates how to properly integrate SQLite database operations with orbit, focusing on:
...
2. **Code Organization**
   - Clear separation between database operations and orbit components
...
- ID: 1
  Title: Example Task
  Description: This is an example task created using orbit
  Status: pending
