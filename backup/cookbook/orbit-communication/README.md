# orbit Communication Example

This example demonstrates the [Communication](https://the-pocket.github.io/orbit/communication.html) concept in orbit, specifically focusing on the Shared Store pattern.
