"""
Core tracing functionality for orbit with Langfuse integration.
"""
...
class LangfuseTracer:
    """
    Core tracer class that handles Langfuse integration for orbit.
    """
    ...
    def _serialize_data(self, data: Any) -> Any:
        ...
        """
        try:
            # Handle common orbit data types
