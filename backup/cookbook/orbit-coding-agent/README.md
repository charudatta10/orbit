...
A production-ready coding agent built with orbit that autonomously implements skeleton code to make failing tests pass. It uses an LLM-driven tool loop with 6 tools, persistent memory across sessions, and project-specific skills loading.
